...
public class MoreMineralsMod
{
	...
	public void load(FMLInitializationEvent event)
	{
		...
		dusts = (CustomItem) new CustomItem(dusts_ID, CSString.concatAll(allnames, "", " Dust"), CSString.concatAll(alloverlays, "dust", "")).setUnlocalizedName("MM_Dusts").setCreativeTab(rawMaterialsTab);
		nuggets = (CustomItem) new CustomItem(nuggets_ID, CSString.concatAll(allnames, "", " Nugget"), CSString.concatAll(alloverlays, "nugget", "")).setUnlocalizedName("MM_Nuggets").setCreativeTab(rawMaterialsTab);
		gems = (CustomItem) new CustomItem(gems_ID, gemnames, CSString.concatAll(gemoverlays, "gem", "")).setUnlocalizedName("MM_Gems").setCreativeTab(rawMaterialsTab);
		...
		vanillaSpecialOres1 = (CustomBlock) new CustomBlock(vanillaOres_ID, Material.rock, vanillaNames, CSString.concatAll(CSArrays.concat(vanillaoverlays, vanillaoverlays), "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab, netherOresTab, netherOresTab, netherOresTab, netherOresTab, netherOresTab, netherOresTab, endOresTab, endOresTab, endOresTab, endOresTab, endOresTab, endOresTab, endOresTab, endOresTab }).setUnlocalizedName("MM_VanillaSpecialOres").setHardness(2.15F);
		vanillaSpecialOres2 = (CustomBlock) new BlockVanillaSpecialOre(vanillaOres_ID2, Material.ground, vanillaNames2, CSString.concatAll(CSArrays.concat(vanillaoverlays, vanillaoverlays), "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab, dirtOresTab, dirtOresTab, dirtOresTab, dirtOresTab, dirtOresTab, dirtOresTab, sandOresTab, sandOresTab, sandOresTab, sandOresTab, sandOresTab, sandOresTab, sandOresTab }).setUnlocalizedName("MM_VanillaSpecialOres2").setHardness(1.7F);
		
		stoneOres1 = (CustomBlock) new CustomBlock(stoneOres_ID1, Material.rock, CSString.concatAll(names1, "", " Ore"), CSString.concatAll(overlays1, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres1").setHardness(2.3F);
		stoneOres2 = (CustomBlock) new CustomBlock(stoneOres_ID2, Material.rock, CSString.concatAll(names2, "", " Ore"), CSString.concatAll(overlays2, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres2").setHardness(2.3F);
		stoneOres3 = (CustomBlock) new CustomBlock(stoneOres_ID3, Material.rock, CSString.concatAll(names3, "", " Ore"), CSString.concatAll(overlays3, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres3").setHardness(2.3F);
		stoneOres4 = (CustomBlock) new CustomBlock(stoneOres_ID4, Material.rock, CSString.concatAll(names4, "", " Ore"), CSString.concatAll(overlays4, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres4").setHardness(2.3F);
		stoneOres5 = (CustomBlock) new CustomBlock(stoneOres_ID5, Material.rock, CSString.concatAll(names5, "", " Ore"), CSString.concatAll(overlays5, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres5").setHardness(2.3F);
		stoneOres6 = (CustomBlock) new CustomBlock(stoneOres_ID6, Material.rock, CSString.concatAll(names6, "", " Ore"), CSString.concatAll(overlays6, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres6").setHardness(2.3F);
		stoneOres7 = (CustomBlock) new CustomBlock(stoneOres_ID7, Material.rock, CSString.concatAll(names7, "", " Ore"), CSString.concatAll(overlays7, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres7").setHardness(2.3F);
		stoneOres8 = (CustomBlock) new CustomBlock(stoneOres_ID8, Material.rock, CSString.concatAll(names8, "", " Ore"), CSString.concatAll(overlays8, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { stoneOresTab }).setUnlocalizedName("MM_StoneOres8").setHardness(2.3F);
		
		netherOres1 = (CustomBlock) new CustomBlock(netherOres_ID1, Material.rock, CSString.concatAll(names1, "Nether ", " Ore"), CSString.concatAll(overlays1, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres1").setHardness(2.1F);
		netherOres2 = (CustomBlock) new CustomBlock(netherOres_ID2, Material.rock, CSString.concatAll(names2, "Nether ", " Ore"), CSString.concatAll(overlays2, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres2").setHardness(2.1F);
		netherOres3 = (CustomBlock) new CustomBlock(netherOres_ID3, Material.rock, CSString.concatAll(names3, "Nether ", " Ore"), CSString.concatAll(overlays3, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres3").setHardness(2.1F);
		netherOres4 = (CustomBlock) new CustomBlock(netherOres_ID4, Material.rock, CSString.concatAll(names4, "Nether ", " Ore"), CSString.concatAll(overlays4, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres4").setHardness(2.1F);
		netherOres5 = (CustomBlock) new CustomBlock(netherOres_ID5, Material.rock, CSString.concatAll(names5, "Nether ", " Ore"), CSString.concatAll(overlays5, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres5").setHardness(2.1F);
		netherOres6 = (CustomBlock) new CustomBlock(netherOres_ID6, Material.rock, CSString.concatAll(names6, "Nether ", " Ore"), CSString.concatAll(overlays6, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres6").setHardness(2.1F);
		netherOres7 = (CustomBlock) new CustomBlock(netherOres_ID7, Material.rock, CSString.concatAll(names7, "Nether ", " Ore"), CSString.concatAll(overlays7, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres7").setHardness(2.1F);
		netherOres8 = (CustomBlock) new CustomBlock(netherOres_ID8, Material.rock, CSString.concatAll(names8, "Nether ", " Ore"), CSString.concatAll(overlays8, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { netherOresTab }).setUnlocalizedName("MM_NetherOres8").setHardness(2.1F);
		
		endOres1 = (CustomBlock) new CustomBlock(endOres_ID1, Material.rock, CSString.concatAll(names1, "End ", " Ore"), CSString.concatAll(overlays1, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres1").setHardness(2.2F);
		endOres2 = (CustomBlock) new CustomBlock(endOres_ID2, Material.rock, CSString.concatAll(names2, "End ", " Ore"), CSString.concatAll(overlays2, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres2").setHardness(2.2F);
		endOres3 = (CustomBlock) new CustomBlock(endOres_ID3, Material.rock, CSString.concatAll(names3, "End ", " Ore"), CSString.concatAll(overlays3, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres3").setHardness(2.2F);
		endOres4 = (CustomBlock) new CustomBlock(endOres_ID4, Material.rock, CSString.concatAll(names4, "End ", " Ore"), CSString.concatAll(overlays4, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres4").setHardness(2.2F);
		endOres5 = (CustomBlock) new CustomBlock(endOres_ID5, Material.rock, CSString.concatAll(names5, "End ", " Ore"), CSString.concatAll(overlays5, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres5").setHardness(2.2F);
		endOres6 = (CustomBlock) new CustomBlock(endOres_ID6, Material.rock, CSString.concatAll(names6, "End ", " Ore"), CSString.concatAll(overlays6, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres6").setHardness(2.2F);
		endOres7 = (CustomBlock) new CustomBlock(endOres_ID7, Material.rock, CSString.concatAll(names7, "End ", " Ore"), CSString.concatAll(overlays7, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres7").setHardness(2.2F);
		endOres8 = (CustomBlock) new CustomBlock(endOres_ID8, Material.rock, CSString.concatAll(names8, "End ", " Ore"), CSString.concatAll(overlays8, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { endOresTab }).setUnlocalizedName("MM_EndOres8").setHardness(2.2F);
		...
		dirtOres1 = (CustomBlock) new BlockDirtOre(dirtOres_ID1, Material.ground, CSString.concatAll(names1, "Dirt-Based ", " Ore"), CSString.concatAll(overlays1, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres1").setHardness(1.7F);
		dirtOres2 = (CustomBlock) new BlockDirtOre(dirtOres_ID2, Material.ground, CSString.concatAll(names2, "Dirt-Based ", " Ore"), CSString.concatAll(overlays2, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres2").setHardness(1.7F);
		dirtOres3 = (CustomBlock) new BlockDirtOre(dirtOres_ID3, Material.ground, CSString.concatAll(names3, "Dirt-Based ", " Ore"), CSString.concatAll(overlays3, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres3").setHardness(1.7F);
		dirtOres4 = (CustomBlock) new BlockDirtOre(dirtOres_ID4, Material.ground, CSString.concatAll(names4, "Dirt-Based ", " Ore"), CSString.concatAll(overlays4, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres4").setHardness(1.7F);
		dirtOres5 = (CustomBlock) new BlockDirtOre(dirtOres_ID5, Material.ground, CSString.concatAll(names5, "Dirt-Based ", " Ore"), CSString.concatAll(overlays5, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres5").setHardness(1.7F);
		dirtOres6 = (CustomBlock) new BlockDirtOre(dirtOres_ID6, Material.ground, CSString.concatAll(names6, "Dirt-Based ", " Ore"), CSString.concatAll(overlays6, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres6").setHardness(1.7F);
		dirtOres7 = (CustomBlock) new BlockDirtOre(dirtOres_ID7, Material.ground, CSString.concatAll(names7, "Dirt-Based ", " Ore"), CSString.concatAll(overlays7, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres7").setHardness(1.7F);
		dirtOres8 = (CustomBlock) new BlockDirtOre(dirtOres_ID8, Material.ground, CSString.concatAll(names8, "Dirt-Based ", " Ore"), CSString.concatAll(overlays8, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { dirtOresTab }).setUnlocalizedName("MM_DirtOres8").setHardness(1.7F);
		
		sandOres1 = (CustomBlock) new BlockSandOre(sandOres_ID1, Material.ground, CSString.concatAll(names1, "Sand-Based ", " Ore"), CSString.concatAll(overlays1, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres1").setHardness(1.7F);
		sandOres2 = (CustomBlock) new BlockSandOre(sandOres_ID2, Material.ground, CSString.concatAll(names2, "Sand-Based ", " Ore"), CSString.concatAll(overlays2, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres2").setHardness(1.7F);
		sandOres3 = (CustomBlock) new BlockSandOre(sandOres_ID3, Material.ground, CSString.concatAll(names3, "Sand-Based ", " Ore"), CSString.concatAll(overlays3, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres3").setHardness(1.7F);
		sandOres4 = (CustomBlock) new BlockSandOre(sandOres_ID4, Material.ground, CSString.concatAll(names4, "Sand-Based ", " Ore"), CSString.concatAll(overlays4, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres4").setHardness(1.7F);
		sandOres5 = (CustomBlock) new BlockSandOre(sandOres_ID5, Material.ground, CSString.concatAll(names5, "Sand-Based ", " Ore"), CSString.concatAll(overlays5, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres5").setHardness(1.7F);
		sandOres6 = (CustomBlock) new BlockSandOre(sandOres_ID6, Material.ground, CSString.concatAll(names6, "Sand-Based ", " Ore"), CSString.concatAll(overlays6, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres6").setHardness(1.7F);
		sandOres7 = (CustomBlock) new BlockSandOre(sandOres_ID7, Material.ground, CSString.concatAll(names7, "Sand-Based ", " Ore"), CSString.concatAll(overlays7, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres7").setHardness(1.7F);
		sandOres8 = (CustomBlock) new BlockSandOre(sandOres_ID8, Material.ground, CSString.concatAll(names8, "Sand-Based ", " Ore"), CSString.concatAll(overlays8, "", "overlay"), true, MMMClientProxy.oreRenderer, new CreativeTabs[] { sandOresTab }).setUnlocalizedName("MM_SandOres8").setHardness(1.7F);
		
		storageBlocks1 = (CustomBlock) new CustomBlock(storageBlocks_ID1, Material.iron, CSString.concatAll(names1, "Block of ", ""), CSString.concatAll(overlays1, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks1").setHardness(2.5F);
		storageBlocks2 = (CustomBlock) new CustomBlock(storageBlocks_ID2, Material.iron, CSString.concatAll(names2, "Block of ", ""), CSString.concatAll(overlays2, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks2").setHardness(2.5F);
		storageBlocks3 = (CustomBlock) new CustomBlock(storageBlocks_ID3, Material.iron, CSString.concatAll(names3, "Block of ", ""), CSString.concatAll(overlays3, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks3").setHardness(2.5F);
		storageBlocks4 = (CustomBlock) new CustomBlock(storageBlocks_ID4, Material.iron, CSString.concatAll(names4, "Block of ", ""), CSString.concatAll(overlays4, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks4").setHardness(2.5F);
		storageBlocks5 = (CustomBlock) new CustomBlock(storageBlocks_ID5, Material.iron, CSString.concatAll(names5, "Block of ", ""), CSString.concatAll(overlays5, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks5").setHardness(2.5F);
		storageBlocks6 = (CustomBlock) new CustomBlock(storageBlocks_ID6, Material.iron, CSString.concatAll(names6, "Block of ", ""), CSString.concatAll(overlays6, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks6").setHardness(2.5F);
		storageBlocks7 = (CustomBlock) new CustomBlock(storageBlocks_ID7, Material.iron, CSString.concatAll(names7, "Block of ", ""), CSString.concatAll(overlays7, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks7").setHardness(2.5F);
		storageBlocks8 = (CustomBlock) new CustomBlock(storageBlocks_ID8, Material.iron, CSString.concatAll(names8, "Block of ", ""), CSString.concatAll(overlays8, "", "block"), new CreativeTabs[] { rawMaterialsTab }).setUnlocalizedName("MM_StorageBlocks8").setHardness(2.5F);
