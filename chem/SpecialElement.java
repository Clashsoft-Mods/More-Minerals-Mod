...
public class SpecialElement extends Element
{
	...
	public SpecialElement(int number, String name, String symbol, String mass, ElementClass elementClass)
	{
		super(PeriodicTable.SPECIAL_LOW + number, name, symbol, mass, elementClass, -1, -1);
	}
}
